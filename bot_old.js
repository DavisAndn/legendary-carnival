    ...
    if(error)
        ...
        console.log("Screenshot done");
              ...
              gm('screenshot.jpg')
                    ...
                    Jimp.read("question.jpg", (err, image) => {
                  if (err) throw err;
                  image.greyscale();
                  image.resize(Jimp.AUTO, 170);
                  image.invert().write("question.jpg");
                          ...
                          if(err) {
                           ...
                           // question=question.split("*")[1];
                            ...
                            //opn(fqustn, {app: 'chrome'});
                             ...
                             gm('screenshot.jpg')
                              .crop('337', '170', '595', '345')
                              .write('answers.jpg', function (err) {
                                

                                Jimp.read("answers.jpg", (err, image) => {
                  if (err) throw err;
                  image.greyscale();
                  image.resize(Jimp.AUTO,450);
                  image.invert().write("answers.jpg");
